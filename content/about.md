---
title: "About Market Dimensions"
eyebrow: "About"
description: "A standalone observatory, operated under the AI Formation Governance Standard, as an instrument of The AI Governance Company."
---

## What this is

Market Dimensions begins with a question that sounds like a parlor trick and turns out to be a measurement: *what if we read the stock market as an organism?* It is a public instrument for reading the market as a living body rather than a price series. It measures the *shape* of the market — how much independent room a basket of twenty stocks keeps between themselves — because we suspect shape carries what prices hide — the slow loss of structure we see a year before Lehman in the replay, the instant clench of 2020, and what looks, right now, like a directed migration of capital. Suspect is the operative word; the ledger is where it becomes more than that.

It is also a map, and all maps lie. Ours draws the body instead of the events, motion instead of position, and the week instead of the hour — and it leaves out nearly everything the front page shows. What that gains you and what it costs you is stated up front in the [Field Guide's legend](/field-guide/projection/).
...
Market Dimensions is founded and written by Christa Burger, with the co-founders of The AI Governance Company, Matt Goodrich and Chris Honaker. The geometry was developed in collaboration with AI systems that are themselves operated under the standard; the machine that runs the Observatory was built and deployed the same way. That is the point.

## What this is not

Not investment advice. Not a signal service. Not a recommendation to buy, sell, or hold anything. The portfolio discussed on this site is a paper experiment and is always labeled as one. If you make financial decisions, make them with a licensed professional who knows your situation.
